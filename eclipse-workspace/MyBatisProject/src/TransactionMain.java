...
public static void main(String[] args) {
      ...
      service.setDao(new TransactionDAO());
      ...
      while (true){
         ...
         System.out.println("5.상품 개수 조회");
         System.out.println("0. 종료");
         System.out.println("------------");
         String num = scan.next();
         
         if("1".equals(num)) {
            List<TransactionDTO> list = service.findAllTransaction();
            ...
            int result = service.insertTransaction(sqlsession, dto);
             if (result > 0) {
             ...
             TransactionDTO dto = new TransactionDTO(transactionID, transactionDate, amount);
             sqlsession = MySqlSessionFactory.getSession();
             int result = service.updateTransaction(sqlsession, dto);
             if (result > 0) {
            ...
            String transactionID = scan.next();
            int n = service.removeByTransactionID(transactionID);
